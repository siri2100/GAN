...
for i in range(EPOCH_INIT - 1, EPOCH_FINE):
    ...
    path_image_dst = f'{path_parent}/data/dst/DCGAN_{DATASET}_{EXP_NAME}/images_{epoch}epoch'
...
df.to_csv(f'{path_parent}/data/dst/DCGAN_{DATASET}_{EXP_NAME}/performance_metric.csv')
